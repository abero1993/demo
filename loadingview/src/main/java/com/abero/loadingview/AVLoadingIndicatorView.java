...
public class AVLoadingIndicatorView extends View {
    ...
    private static final CubeTransitionIndicator DEFAULT_INDICATOR = new CubeTransitionIndicator();
    ...
    private final Runnable mDelayedShow = new Runnable() {
        ...
        public void run() {
            ...
            Log.i(TAG, "run show  " + mPostedShow);
        }
    };
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        Log.i(TAG, "minw=" + mMinWidth + " minh=" + mMinHeight);
    ...
    public void setIndicator(String indicatorName) {
        ...
        Log.i(TAG, "class=" + drawableClassName.toString());
        try {
    ...
    protected synchronized void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.i(TAG, "onMeasure W=" + measuredWidth + " H=" + measuredHeight);
