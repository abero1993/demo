...
public class MagicRecordFilter extends GPUImageFilter {
    ...
    private static final String TAG = "MagicRecordFilter";
    ...
    public void initPixelBuffer(int width, int height) {
        ...
        Log.i(TAG, "rowStride=" + mRowStride + " height=" + height);

        mPboSize = mRowStride * height;

        Log.i(TAG, "pbo size=" + mPboSize);
    ...
    public void startRecord(String filePath) {
        ...
        mRecordHelper.start(0,mInputWidth, mInputHeight, new File(filePath));
    ...
    private void bindPixelBuffer() {
        ...
        ByteBuffer byteBuffer = ((ByteBuffer) GLES30.glMapBufferRange(GLES30.GL_PIXEL_PACK_BUFFER, 0, mPboSize,
                GLES30.GL_MAP_READ_BIT));

        //Log.i(TAG,"byte addr="+byteBuffer.hashCode());
