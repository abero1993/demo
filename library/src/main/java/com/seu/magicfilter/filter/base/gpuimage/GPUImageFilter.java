...
public class GPUImageFilter {
    ...
    public GPUImageFilter(int vertexShaderId, int fragmentShaderId) {
        ...
        for (int i = 0; i < 8; i++)
            Log.i(TAG, "mGLTextureBuffer i=" + i + " value=" + mGLTextureBuffer.get(i));
    }
    ...
    public void initFrameBuffer(int width, int height) {
        ...
        GLES20.glTexParameterf(GLES20.GL_TEXTURE_2D, GLES20.GL_TEXTURE_MAG_FILTER, GLES20.GL_LINEAR); //纹理过滤
        GLES20.glTexParameterf(GLES20.GL_TEXTURE_2D, GLES20.GL_TEXTURE_MIN_FILTER, GLES20.GL_LINEAR);
        GLES20.glTexParameterf(GLES20.GL_TEXTURE_2D, GLES20.GL_TEXTURE_WRAP_S, GLES20.GL_CLAMP_TO_EDGE); //纹理环绕方式
    ...
    public int onDrawFrameAndReadPix(final int textureId,FloatBuffer cubeBuffer,FloatBuffer textureBuffer) {
       ...
       /* if (!mIsInitialized) {
        ...
        /*GLES20.glBindBuffer(GLES20.GL_ARRAY_BUFFER, mFrameBuffers[0]);
        GLES20.glEnableVertexAttribArray(mGLAttributePosition);
        GLES20.glVertexAttribPointer(mGLAttributePosition, 2, GLES20.GL_FLOAT, false, 4 * 2, 0);

        GLES20.glBindBuffer(GLES20.GL_ARRAY_BUFFER, mFrameBufferTextures[0]);
        GLES20.glEnableVertexAttribArray(mGLAttributeTextureCoordinate);
        GLES20.glVertexAttribPointer(mGLAttributeTextureCoordinate, 2, GLES20.GL_FLOAT, false, 4 * 2, 0);*/
