...
public class MediaMuxerWrapper {
    ...
    private static final String DIR_NAME = "motube";
     ...
     * @throws IOException
     */
    public MediaMuxerWrapper(String ext, int orientation) throws IOException {

        try {
            if (TextUtils.isEmpty(ext)) {
                mOutputPath = getCaptureFile(Environment.DIRECTORY_DCIM, ".mp4").toString();
            } else {
...
//**********************************************************************
     ...
     */
    /*package*/
    synchronized void writeSampleData(final int trackIndex, final ByteBuffer byteBuf, final MediaCodec.BufferInfo
            bufferInfo) {
        if (mStatredCount > 0)
...
//**********************************************************************
    ...
    public static final File getCaptureFile(final String path) {
