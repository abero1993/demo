...
public class Drawable2d {
    ...
    // 0.97770196 0.0 0.97770196 1.0 0.022298038 0.0 0.022298038 1.0
    ...
    public Drawable2d(Prefab shape) {
        switch (shape) {
            ...
            case FULL_RECTANGLE:
                ...
                mTexCoordArray = GlUtil.createFloatBuffer(TextureRotationUtil.getRotation(Rotation.NORMAL, true, false));
    ...
    public void putTextCoordArray(float[] array)
    {
        mTexCoordArray.put(array);
    }
