...
public class Texture2dProgram {
    ...
    private static final String DEF_VERTEX_SHADER =
            "attribute vec4 aPosition;\n" +
                    "attribute vec4 aTextureCoord;\n" +
                    "varying vec2 vTextureCoord;\n" +
                    "void main() {\n" +
    ...
    public Texture2dProgram(ProgramType programType) {
        ...
        switch (programType) {
            case TEXTURE_2D:
                Log.i(TAG, "Texture2dProgram: TEXTURE_2D ");
                mTextureTarget = GLES20.GL_TEXTURE_2D;
                mProgramHandle = GlUtil.createProgram(VERTEX_SHADER, FRAGMENT_SHADER_2D);
                break;
            case TEXTURE_EXT:
                Log.i(TAG, "Texture2dProgram: TEXTURE_EXT ");
                mTextureTarget = GLES20.GL_TEXTURE_2D;
                mProgramHandle = GlUtil.createProgram(DEF_VERTEX_SHADER, FRAGMENT_SHADER_2D);
                break;
            case TEXTURE_EXT_BW:
                Log.i(TAG, "Texture2dProgram: TEXTURE_EXT_BW ");
                mTextureTarget = GLES11Ext.GL_TEXTURE_EXTERNAL_OES;
                mProgramHandle = GlUtil.createProgram(VERTEX_SHADER, FRAGMENT_SHADER_EXT_BW);
                break;
            case TEXTURE_EXT_FILT:
                Log.i(TAG, "Texture2dProgram: TEXTURE_EXT_FILT ");
                mTextureTarget = GLES11Ext.GL_TEXTURE_EXTERNAL_OES;
        ...
        Log.i(TAG, "Texture2dProgram: done");
    }
